...
@Service
public class CustomUserDetailServiceImpl implements UserDetailsService, UserService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		return user.map(UserDetailsImpl::new).orElseThrow(()->new UserNotFoundException("no user found "));
	}
